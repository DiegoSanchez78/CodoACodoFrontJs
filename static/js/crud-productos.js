class Producto{
    ...
    constructor(id,Categoria,nombre_producto,material,descripcion,precio,imagen){
        this.id=id;
...
function saveProducto(){
    ...
    if(inputProducto.value.trim() !== ''){
        ...
        if(inputId.value!==""){
            ...
            if (productoFind) {
              productoFind.Categoria = inputCategoria.value;
              productoFind.nombre_produc = inputNombre.value;
              productoFind.Material = inputMaterial.value;
              productoFind.descripcion = inputDescripción.value;
              productoFind.Precio = inputPrecio.value;
              productoFind.imagen = inputFoto.value;
            }
        }else{
...
function updateProducto(productoId){
    ...
    if(movieToUpdate){
        ...
        inputCategoria.value = productoToUpdate.Categoria;
        ...
        inputFoto.value = productoToUpdate.imagen;
    }
}
